...
#define PermutationSize 1920
#define PermutationSizeInBytes (PermutationSize/8)
#define MaximumRate 1408
#define MaximumRateInBytes (MaximumRate/8)
...
ALIGN typedef struct spongeStateStruct {
    ...
    ALIGN unsigned char dataQueue[MaximumRateInBytes];
    unsigned int rate;
...
/**
  * Function to initialize the state of the Hash[r, c] sponge function.
  ...
  * @pre    One must have r+c=1920 and the rate a multiple of 64 bits in this implementation.
