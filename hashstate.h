...
#ifndef _NISTInterface_h_
#define _NISTInterface_h_
...
/**
  * Function to initialize the state of the  sponge function.
  ...
  *                     or 0 for hash[] with default parameters
...
/**
  * Function to compute a hash using the  sponge function.
  * The rate r and capacity c values are determined from @a hashbitlen.
  * @param  hashbitlen  The desired number of output bits.
  * @param  data        Pointer to the input data. 
  *                     When @a databitLen is not a multiple of 8, the last bits of data must be
